...
namespace ZenDays.Service.Services
{
		...
		where J : BaseDTO
	{
		...
		public async Task<ResultViewModel> Get(string id)
		{
			...
			return fromdb is null ? new ResultViewModel(null, 404, false, ErrorMessages.NotFound) : new ResultViewModel(_mapper.Map<J>(fromdb), 200, true, SuccessMessages.Found);
		}
